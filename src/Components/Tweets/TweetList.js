      ...
      <div className="content-box" key={idx} style={{position:'relative'}}>
        ...
        <div className="content-right">
          ...
          <div className="tweet-icons">
            ...
            <div className="d-flex align-items-center pt-1 pe-3 ps-1 blue-count"
                  onClick={(e) => { if (token) { e.preventDefault(); setTweet(idx); setShow(true) }}}
            >{comments.length}</div>
            ...
            <div className="d-flex align-items-center pt-1 pe-3 ps-1 pink-count"
                  onClick={(e) => { token && likeTweet(e, id, likeCount) }}>{likeCount}</div>
          </div>
        </div>
      </div>
    </Link>
