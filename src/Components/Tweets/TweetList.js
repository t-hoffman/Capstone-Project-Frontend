      ...
      <div className="content-box" key={idx}>
        ...
        <div className="content-right">
          ...
          <div className="tweet-icons">
            ...
            <div className="d-flex align-items-center pt-1 pe-3" style={{color:'#849099'}}>{comments.length}</div>
            ...
            <div className="d-flex align-items-center pt-1 pe-3" style={{color:'#849099'}}>{likeCount}</div>
          </div>
        </div>
      </div>
    </Link>
